...
//#define DUAL_X_CARRIAGE
  ...
  #define X1_MAX_POS   170        // A max coordinate so the X1 carriage can't hit the parked X2 carriage
  #define X2_MIN_POS    70        // A min coordinate so the X2 carriage can't hit the parked X1 carriage
  #define X2_MAX_POS   221.5      // The max position of the X2 carriage, typically also the home position
