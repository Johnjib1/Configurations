...
#define HOMING_BUMP_DIVISOR { 10, 10, 4 }     // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_XY 8       // (steps or mm) Steps or millimeter distance for each XY babystep
