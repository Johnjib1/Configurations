...
#define CONFIG_EXAMPLES_DIR "Creality/CR-10 V3/BigTreeTech SKR Mini E3 v3"
...
#define STRING_CONFIG_H_AUTHOR "(PurseChicken, CR-10 V3)" // Original author or contributor.
...
#define Z_PROBE_FEEDRATE_FAST (14*60) // (mm/min)
