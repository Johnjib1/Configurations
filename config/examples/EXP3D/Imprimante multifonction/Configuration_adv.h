 ...
 */
  ...
  #define THERMAL_PROTECTION_CHAMBER_HYSTERESIS 5 // (°C)

  /**
   * Heated chamber watch settings (M141/M191).
   */
  #define WATCH_CHAMBER_TEMP_PERIOD            60 // (seconds)
  #define WATCH_CHAMBER_TEMP_INCREASE           5 // (°C)
#endif
...
#define HOMING_BUMP_MM      { 4, 4, 4 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // Double-click on the Status Screen for Z Babystepping.
    ...
    #define DOUBLECLICK_MAX_INTERVAL 2000   // (ms) Maximum interval between clicks.
