...
#define CONFIG_EXAMPLES_DIR "Sovol/SV-06 Plus"
 ...
 */
  ...
  #define X_HYBRID_THRESHOLD     250  // [mm/s]
  #define X2_HYBRID_THRESHOLD    180
  #define Y_HYBRID_THRESHOLD     250
